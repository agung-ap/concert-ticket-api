...
const (
	...
	BookingService_BookTickets_FullMethodName     = "/booking.BookingService/BookTickets"
...
type BookingServiceClient interface {
	...
	BookTickets(ctx context.Context, in *BookTicketsRequest, opts ...grpc.CallOption) (*Booking, error)
...
func (c *bookingServiceClient) BookTickets(ctx context.Context, in *BookTicketsRequest, opts ...grpc.CallOption) (*Booking, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Booking)
	err := c.cc.Invoke(ctx, BookingService_BookTickets_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BookingServiceServer interface {
	...
	BookTickets(context.Context, *BookTicketsRequest) (*Booking, error)
...
func (UnimplementedBookingServiceServer) BookTickets(context.Context, *BookTicketsRequest) (*Booking, error) {
...
func _BookingService_BookTickets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BookTicketsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BookingServiceServer).BookTickets(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BookingService_BookTickets_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookingServiceServer).BookTickets(ctx, req.(*BookTicketsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BookingService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _BookingService_BookTickets_Handler,
		},
		{
	...
	Metadata: "api/grpc/proto/booking.proto",
}
